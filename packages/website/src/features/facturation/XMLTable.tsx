            ...
            <table className={css({ width: "100%", borderCollapse: "collapse", fontSize: "sm" })}>
                ...
                <tfoot>
                    <tr className={css({ borderTop: "2px solid token(colors.neutral/10)" })}>
                        <td className={css({ padding: "0.6rem", fontWeight: "600" })}>Total</td>
                        <td />
                        <td />
                        <td className={css({ textAlign: "right", padding: "0.6rem", fontWeight: "600" })}>
                            {parsed.amountHT || "-"}
                        </td>
                        <td className={css({ textAlign: "right", padding: "0.6rem", fontWeight: "600" })}>
                            {parsed.amountTVA || "-"}
                        </td>
                        <td className={css({ textAlign: "right", padding: "0.6rem", fontWeight: "700" })}>
                            {parsed.amountTTC || "-"}
                        </td>
                    </tr>
                </tfoot>
