...
export default function Content() {
    ...
    return (<>
            ...
            backgroundColor: "background",
                            ...
                            <IconBrandLinkedin className={css({
            width: "1.25rem",
            height: "1.25rem",
            color: "neutral",
        })}/>
            ...
            gap: "0.75rem",
                    ...
                    <LinkButton to="/documentation/comptabilité" className={{
            width: "100%",
            gap: "0.75rem",
            padding: "1rem",
            borderRadius: "md",
            ...
            color: "neutral/50",
                    ...
                    <LinkButton to="/documentation/dashboard" className={{
            width: "100%",
            gap: "0.75rem",
            padding: "1rem",
            borderRadius: "md",
            ...
            color: "neutral/50",
                    ...
                    <LinkButton to="/documentation/api" className={{
            width: "100%",
            gap: "0.75rem",
            padding: "1rem",
            borderRadius: "md",
