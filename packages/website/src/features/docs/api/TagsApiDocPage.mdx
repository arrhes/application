import { createOneTagRouteDefinition, deleteOneTagRouteDefinition, readAllTagsRouteDefinition, readOneTagRouteDefinition, updateOneTagRouteDefinition, } from "@arrhes/application-metadata/routes";
...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Libellés" description="Libellés d'écriture réutilisables pour catégoriser les écritures comptables"/>
