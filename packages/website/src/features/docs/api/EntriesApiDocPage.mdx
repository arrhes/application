...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Écritures" description="Écritures comptables et tags associés"/>
            ...
            <DocSection title="Écritures">
                ...
                <DocRouteRequest routeDefinition={createOneEntryFromTemplateRouteDefinition} description="Créer une écriture avec des lignes pré-remplies en une seule requête."/>
                ...
                <DocRouteRequest routeDefinition={reverseOneEntryRouteDefinition} description="Créer une écriture de contre-passation (inversion des débits et crédits)."/>
            </DocSection>
            ...
            <DocSection title="Lignes d'écriture">
                ...
                <DocRouteRequest routeDefinition={updateManyEntryLinesRouteDefinition} description="Modifier en masse toutes les lignes d'une écriture."/>
