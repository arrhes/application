...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Lignes d'écriture" description="Lignes de débit/crédit et tags des écritures comptables"/>
