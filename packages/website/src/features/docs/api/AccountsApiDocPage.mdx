import { createOneAccountRouteDefinition, deleteOneAccountRouteDefinition, readAllAccountsRouteDefinition, readOneAccountRouteDefinition, updateOneAccountRouteDefinition, } from "@arrhes/application-metadata/routes";
...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Comptes" description="Plan comptable de l'exercice : création, lecture, modification et suppression des comptes"/>
