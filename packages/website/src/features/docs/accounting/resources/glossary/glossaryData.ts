...
export const glossaryTerms: GlossaryTerm[] = [
    defineTerm(
        ...
        {
            sources: [{ label: "Actif - Wikipédia", url: "https://fr.wikipedia.org/wiki/Actif_(comptabilité)" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Annexe - Wikipédia", url: "https://fr.wikipedia.org/wiki/Annexe_(comptabilité)" }],
    ...
    defineTerm(
        ...
        {
            sources: [
                { label: "Balance comptable - Wikipédia", url: "https://fr.wikipedia.org/wiki/Balance_comptable" },
            ],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Bénéfice - Wikipédia", url: "https://fr.wikipedia.org/wiki/Bénéfice_(comptabilité)" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Balance sheet - Wikipedia", url: "https://en.wikipedia.org/wiki/Balance_sheet" }],
    ...
    defineTerm(
        ...
        {
            sources: [
                { label: "Capital social - Wikipédia", url: "https://fr.wikipedia.org/wiki/Capital_social_(finance)" },
            ],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Equity (finance) - Wikipedia", url: "https://en.wikipedia.org/wiki/Equity_(finance)" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Expense - Wikipedia", url: "https://en.wikipedia.org/wiki/Expense" }],
    ...
    defineTerm(
        ...
        {
            sources: [
                { label: "Chart of accounts - Wikipedia", url: "https://en.wikipedia.org/wiki/Chart_of_accounts" },
            ],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Income statement - Wikipedia", url: "https://en.wikipedia.org/wiki/Income_statement" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Personal account - Wikipedia", url: "https://en.wikipedia.org/wiki/Personal_account" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Nominal account - Wikipedia", url: "https://en.wikipedia.org/wiki/Nominal_account" }],
    ...
    defineTerm(
        ...
        {
            sources: [
                { label: "Debits and credits - Wikipedia", url: "https://en.wikipedia.org/wiki/Debits_and_credits" },
            ],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Journal entry - Wikipedia", url: "https://en.wikipedia.org/wiki/Journal_entry" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Fiscal year - Wikipedia", url: "https://en.wikipedia.org/wiki/Fiscal_year" }],
            relatedTerms: ["Bilan", "Compte de résultat"],
            relatedPages: [{ label: "Les documents", path: "/documentation/comptabilité/documents" }],
        },
    ),
    defineTerm(
        ...
        {
            sources: [{ label: "General ledger - Wikipedia", url: "https://en.wikipedia.org/wiki/General_ledger" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Fixed asset - Wikipedia", url: "https://en.wikipedia.org/wiki/Fixed_asset" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "General journal - Wikipedia", url: "https://en.wikipedia.org/wiki/General_journal" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Special journal - Wikipedia", url: "https://en.wikipedia.org/wiki/Special_journal" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Organization - Wikipedia", url: "https://en.wikipedia.org/wiki/Organization" }],
            relatedPages: [
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Passif - Wikipédia", url: "https://fr.wikipedia.org/wiki/Passif_(comptabilité)" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Source document - Wikipedia", url: "https://en.wikipedia.org/wiki/Source_document" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Income - Wikipedia", url: "https://en.wikipedia.org/wiki/Income" }],
    ...
    defineTerm(
        ...
        {
            sources: [
                { label: "Retained earnings - Wikipedia", url: "https://en.wikipedia.org/wiki/Retained_earnings" },
            ],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Résultat net - Wikipédia", url: "https://fr.wikipedia.org/wiki/Résultat_net" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Inventory - Wikipedia", url: "https://en.wikipedia.org/wiki/Inventory" }],
    ...
    defineTerm(
        ...
        {
            sources: [{ label: "Value-added tax - Wikipedia", url: "https://en.wikipedia.org/wiki/Value-added_tax" }],
