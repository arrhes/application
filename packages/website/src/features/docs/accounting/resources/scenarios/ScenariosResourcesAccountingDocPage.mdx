...
export function ScenarioRow(props) {
    const { scenario } = props;
    return (<LinkButton to="/documentation/comptabilité/ressources/scénarios/$scenario" params={{
            scenario: scenario.id,
        }} className={{
            width: "100%",
        }}>
            <ButtonGhostContent text={scenario.title} className={{
            width: "100%",
...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Scénarios comptables" description="Liste des cas d'usage liés aux comptes du Plan Comptable Général"/>
            ...
            position: "relative",
                ...
                <input type="text" aria-label="Rechercher un scénario" placeholder="capital, 512, fournisseur, amortissement..." value={query} onChange={(e) => handleSearch(e.target.value)} className={css({
            width: "100%",
            ...
            {filteredScenarios.length > 0 ? (<div ref={parentRef} className={css({
                height: "70vh",
                maxHeight: "800px",
                overflow: "auto",
                borderRadius: "lg",
