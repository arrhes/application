...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Le Fichier des Écritures Comptables (FEC)" description="Export normé des écritures comptables requis par l'administration fiscale"/>
            ...
            <DocSection title="Définition">
                ...
                <DocParagraph>
                    ...
                    <a href="https://fec.arrhes.com" target="_blank" rel="noopener noreferrer" className={css({
            fontSize: "sm",
            color: "primary",
            fontWeight: "medium",
