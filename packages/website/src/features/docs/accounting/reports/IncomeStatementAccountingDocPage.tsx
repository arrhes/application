...
export function IncomeStatementAccountingDocPage() {
    return (
        <DocRoot>
            ...
            />
            <IncomeStatementDefinitionSection />
            <IncomeStatementConstructionSection />
            <ResultLevelsSection />
            <IncomeStatementExampleSection />
            <SigSection />
            <ResultVsCashFlowSection />
            <EquitySection />
            <BalanceAndIncomeStatementLinkSection />
            <AssociationsIncomeStatementSection />
            <DocSources
                sources={[
                    {
...
function IncomeStatementDefinitionSection() {
    return (
...
function IncomeStatementConstructionSection() {
    return (
...
function IncomeStatementExampleSection() {
    return (
...
function ResultVsCashFlowSection() {
    return (
...
function BalanceAndIncomeStatementLinkSection() {
    return (
...
function AssociationsIncomeStatementSection() {
    return (
