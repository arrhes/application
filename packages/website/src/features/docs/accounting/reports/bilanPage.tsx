        ...
        <DocRoot>
            ...
            <DocSection title="Définition">
                ...
                <DocParagraph>
                    ...
                    . Contrairement au{" "}
                    <DocLink to="/documentation/comptabilité/documents/compte-de-resultat">compte de résultat</DocLink>{" "}
            ...
            <DocNextPage to="/documentation/comptabilité/documents/compte-de-resultat" label="Le compte de résultat" />
        </DocRoot>
    )
}
