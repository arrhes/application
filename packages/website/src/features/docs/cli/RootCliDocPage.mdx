...
export default function Content() {
    ...
    return (<>
            <DocHeader title="CLI Arrhes" description="Gérez votre comptabilité depuis le terminal"/>
            ...
            <DocSection title="Prochaines étapes">
                <DocList items={[
            <DocLink key="install" to="/documentation/cli/installation">
                            Installer le CLI
                        </DocLink>,
            <DocLink key="auth" to="/documentation/cli/authentification">
                            Se connecter avec une clé API
                        </DocLink>,
            <DocLink key="commands" to="/documentation/cli/commandes">
