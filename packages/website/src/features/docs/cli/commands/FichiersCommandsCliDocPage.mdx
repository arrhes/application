...
export default function Content() {
    ...
    return (<>
            <DocHeader title="Stockage" description="Lister, consulter, enregistrer, modifier, supprimer des fichiers et générer des liens de téléchargement. Les dossiers sont gérés via le sous-groupe arrhes files folders."/>
