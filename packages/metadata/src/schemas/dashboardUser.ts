...
import type { dashboardUserModel } from "../models/dashboardUser.js"

export const dashboardUserSchema = v.object({
...
}) satisfies v.GenericSchema<typeof dashboardUserModel.$inferSelect>

export const dashboardUserSchemaReturn = v.pick(dashboardUserSchema, [
    "id",
    "isActive",
    "alias",
    "email",
