import { createOneEntryRouteDefinition, generateId, models } from "@arrhes/application-metadata"
...
export const createOneEntryRoute = apiFactory.createApp().post(createOneEntryRouteDefinition.path, async (c) => {
