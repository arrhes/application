import { generateIncomeStatementXmlRouteDefinition, models } from "@comptasse/application-metadata"
...
function buildIncomeStatementXbrl(params: {
    ...
    const entityScheme = siren ? "http://www.insee.fr/siren" : "http://www.comptasse.fr/organization"
...
export const generateIncomeStatementXmlRoute = apiFactory
    ...
    .post(generateIncomeStatementXmlRouteDefinition.path, async (c) => {
        ...
        const storageKey = `organizations/${idOrganization}/${body.idYear}/exports/income-statement.xml`
