import { models, updateOneYearRouteDefinition } from "@comptasse/application-metadata"
...
export const updateOneYearRoute = registerRoute(updateOneYearRouteDefinition, async (c) => {
