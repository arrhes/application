import { deleteOneEntryRouteDefinition, models } from "@comptasse/application-metadata"
...
export const deleteOneEntryRoute = registerRoute(deleteOneEntryRouteDefinition, async (c) => {
