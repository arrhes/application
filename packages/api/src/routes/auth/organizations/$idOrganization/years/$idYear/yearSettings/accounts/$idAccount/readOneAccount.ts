import { models, readOneAccountRouteDefinition } from "@comptasse/application-metadata"
...
export const readOneAccountRoute = registerRoute(readOneAccountRouteDefinition, async (c) => {
