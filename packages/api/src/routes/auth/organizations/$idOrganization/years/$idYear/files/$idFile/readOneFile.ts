import { models, readOneFileRouteDefinition } from "@comptasse/application-metadata"
...
export const readOneFileRoute = registerRoute(readOneFileRouteDefinition, async (c) => {
