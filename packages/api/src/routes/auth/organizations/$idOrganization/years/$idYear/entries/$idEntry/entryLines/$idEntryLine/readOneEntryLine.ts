import { models, readOneEntryLineRouteDefinition } from "@comptasse/application-metadata"
...
export const readOneEntryLineRoute = registerRoute(readOneEntryLineRouteDefinition, async (c) => {
