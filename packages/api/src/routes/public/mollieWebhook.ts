            ...
            if (mappedStatus === "paid" && previousStatus !== "paid" && organizationPayment.category === "top_up") {
                ...
                if (organization !== undefined) {
                    await updateOne({
                        ...
                        data: {
                            walletBalanceInCents: organization.walletBalanceInCents + organizationPayment.amountHTInCents,
                            lastUpdatedAt: new Date().toISOString(),
                        },
            ...
            if (mollieCustomerId !== null && mollieCustomerId !== undefined) {
                ...
                if (organization !== undefined) {
                    ...
                    await recordOrganizationPayment({
                        ...
                        status: mappedStatus,
                        amountHTInCents: Math.round(Number.parseFloat(molliePayment.amount.value) * 100),
